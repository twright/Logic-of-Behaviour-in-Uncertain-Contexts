...
std::string Polynomial::as_str() {
	...
	if (monomials.size() == 0) {
		...
		toString(res, varNames);
	}

	// static const char * cres = res.c_str();
	return res;
}
...
{
	printf("computeTaylorExpansion [1]...\n");
	int rangeDim = ode.size();
	printf("size %d...\n", rangeDim);
	printf("computeTaylorExpansion [2]...\n");
	...
	printf("taylorExpansion %d.\n", taylorExpansion.size());
	printf("computeTaylorExpansion [3]...\n");
	printf("TE is %s\n", taylorExpansion.at(0).as_str().c_str());
	...
	printf("computeTaylorExpansion [4]...\n");
	printf("taylorExpansion %d.\n", taylorExpansion.size());
	// printf("taylorExpansion[0] %s.\n", taylorExpansion.at(0).toString());

	for(int i=0; i<taylorExpansion.size(); ++i)
	{
		HornerForm hf;
		taylorExpansion[i].toHornerForm(hf);
		printf("Horner computed\n");
		result.push_back(hf);
	}

	printf("computeTaylorExpansion [end]...\n");
}
