...
static int __Pyx_modinit_function_import_code(void) {
  ...
  __pyx_t_1 = PyImport_ImportModule("flowstar.poly"); if (!__pyx_t_1) __PYX_ERR(0, 1, __pyx_L1_error)
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init flowstar.observable", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
