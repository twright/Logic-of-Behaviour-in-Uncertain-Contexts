...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "flowstar/observable.pyx"
        ]
    }, 
    "module_name": "flowstar.observable"
}
END: Cython Metadata */
...
#define __PYX_HAVE__flowstar__observable
#define __PYX_HAVE_API__flowstar__observable
/* Early includes */
#include <string.h>
#include "ios"
#include "new"
...
#define __Pyx_MODULE_NAME "flowstar.observable"
extern int __pyx_module_is_main_flowstar__observable;
int __pyx_module_is_main_flowstar__observable = 0;

/* Implementation of 'flowstar.observable' */
...
static void __pyx_f_8flowstar_10observable_observable(std::function<flowstar::Interval(const flowstar::Interval &)> &__pyx_v_f_fn, std::function<flowstar::Interval(const flowstar::Interval &)> &__pyx_v_f_prime_fn, flowstar::Polynomial &__pyx_v_f, flowstar::TaylorModelVec &__pyx_v_tmv, std::vector<flowstar::Interval>  &__pyx_v_domain, int __pyx_v_order, flowstar::Interval &__pyx_v_cutoff_threshold) {
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("flowstar.observable.observable", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
}
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("observable", (void (*)(void))__pyx_f_8flowstar_10observable_observable, "void (std::function<flowstar::Interval(const flowstar::Interval &)> &, std::function<flowstar::Interval(const flowstar::Interval &)> &, flowstar::Polynomial &, flowstar::TaylorModelVec &, std::vector<flowstar::Interval>  &, int, flowstar::Interval &)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static int __pyx_pymod_exec_observable(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_flowstar__observable) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "flowstar.observable")) {
      if (unlikely(PyDict_SetItemString(modules, "flowstar.observable", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init flowstar.observable", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init flowstar.observable");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
